...
# warehouse. They are ignored by default.
# show_authors = False
...
# If true, an OpenSearch description file will be warehouse, and all pages will
...
# -- Options for manual page warehouse ---------------------------------------
...
# The HTML theme for the epub warehouse. Since the default themes are not optimized
# for small screen space, using the same theme for HTML and epub warehouse is
