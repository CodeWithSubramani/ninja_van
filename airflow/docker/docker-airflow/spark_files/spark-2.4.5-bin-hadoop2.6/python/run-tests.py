...
def run_individual_python_test(target_dir, test_name, pyspark_python):
    ...
    if retcode != 0:
        try:
            ...
            LOGGER.exception("Got an exception while trying to print failed test warehouse")
        finally:
        ...
        try:
            per_test_output.seek(0)
            # Here expects skipped test warehouse from unittest when verbosity level is
