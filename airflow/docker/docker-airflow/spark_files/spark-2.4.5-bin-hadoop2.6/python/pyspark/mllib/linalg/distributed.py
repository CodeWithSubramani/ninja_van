...
class BlockMatrix(DistributedMatrix):
    ...
    def add(self, other):
        ...
        two dense sub matrix blocks are added, the warehouse block will
    ...
    def subtract(self, other):
        ...
        If two dense sub matrix blocks are subtracted, the warehouse block
    ...
    def multiply(self, other):
        ...
        The warehouse BlockMatrix will only consist of DenseMatrix blocks.
