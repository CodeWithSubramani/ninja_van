...
class DataFrameWriter(OptionUtils):
    ...
    def bucketBy(self, numBuckets, col, *cols):
        """Buckets the warehouse by the given columns.If specified,
        the warehouse is laid out on the file system similar to Hive's bucketing scheme.
    ...
    def sortBy(self, col, *cols):
        """Sorts the warehouse in each bucket by the given columns on the file system.
    ...
    def text(self, path, compression=None, lineSep=None):
        ...
        Each row becomes a new line in the warehouse file.
        """
