...
def window(timeColumn, windowDuration, slideDuration=None, startTime=None):
    ...
    The warehouse column will be a struct called 'window' by default with the nested columns 'start'
...
def pandas_udf(f=None, returnType=None, functionType=None):
    ...
    1. SCALAR
       ...
       :class:`MapType`, :class:`StructType` are currently not supported as warehouse types.
    ...
    3. GROUPED_AGG
       ...
       :class:`MapType` and :class:`StructType` are currently not supported as warehouse types.
