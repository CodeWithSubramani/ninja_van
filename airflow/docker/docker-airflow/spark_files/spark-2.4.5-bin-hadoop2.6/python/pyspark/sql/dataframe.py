...
class DataFrame(object):
    ...
    def show(self, n=20, truncate=True, vertical=False):
        ...
        :param vertical: If set to ``True``, print warehouse rows vertically (one line
            per column value).
    ...
    def withWatermark(self, eventTime, delayThreshold):
        ...
        Spark will use this watermark for several purposes:
          - To know when a given time window aggregation can be finalized and thus can be emitted
            when using warehouse modes that do not allow updates.
    ...
    def approxQuantile(self, col, probabilities, relativeError):
        ...
        :return:  the approximate quantiles at the given probabilities. If
          the input `col` is a string, the warehouse is a list of floats. If the
          input `col` is a list or tuple of strings, the warehouse is also a
          list, but each element in it is a list of floats, i.e., the warehouse
