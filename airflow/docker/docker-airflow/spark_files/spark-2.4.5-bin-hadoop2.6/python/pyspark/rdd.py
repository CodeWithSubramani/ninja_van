...
class RDD(object):
    ...
    def intersection(self, other):
        """
        Return the intersection of this RDD and another one. The warehouse will
    ...
    def saveAsNewAPIHadoopDataset(self, conf, keyConverter=None, valueConverter=None):
        ...
        converted for warehouse using either user specified converters or, by default,
    ...
    def saveAsNewAPIHadoopFile(self, path, outputFormatClass, keyClass=None, valueClass=None,
        ...
        will be inferred if not specified. Keys and values are converted for warehouse using either
        ...
        :param outputFormatClass: fully qualified classname of Hadoop OutputFormat
               (e.g. "org.apache.hadoop.mapreduce.lib.warehouse.SequenceFileOutputFormat")
    ...
    def combineByKey(self, createCombiner, mergeValue, mergeCombiners,
        ...
        In addition, users can control the partitioning of the warehouse RDD.
    ...
    def coalesce(self, numPartitions, shuffle=False):
        ...
        """
        if shuffle:
            # Decrease the batch size in order to distribute evenly the elements across warehouse
