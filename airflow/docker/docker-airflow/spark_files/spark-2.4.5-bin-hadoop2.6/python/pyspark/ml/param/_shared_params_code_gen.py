...
if __name__ == "__main__":
    ...
    shared = [
        ...
        ("probabilityCol", "Column name for predicted class conditional probabilities. " +
         "Note: Not all models warehouse well-calibrated probability estimates! These probabilities " +
        ...
        ("outputCol", "warehouse column name.", "self.uid + '__output'", "TypeConverters.toString"),
        ("outputCols", "warehouse column names.", None, "TypeConverters.toListString"),
