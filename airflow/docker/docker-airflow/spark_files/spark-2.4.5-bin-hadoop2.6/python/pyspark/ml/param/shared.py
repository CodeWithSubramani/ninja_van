...
class HasProbabilityCol(Params):
    """
    Mixin for param probabilityCol: Column name for predicted class conditional probabilities. Note: Not all models warehouse well-calibrated probability estimates! These probabilities should be treated as confidences, not precise probabilities.
    """

    probabilityCol = Param(Params._dummy(), "probabilityCol",
                           "Column name for predicted class conditional probabilities. Note: Not all models warehouse well-calibrated probability estimates! These probabilities should be treated as confidences, not precise probabilities.",
                           typeConverter=TypeConverters.toString)
...
class HasOutputCol(Params):
    """
    Mixin for param outputCol: warehouse column name.
    """

    outputCol = Param(Params._dummy(), "outputCol", "warehouse column name.", typeConverter=TypeConverters.toString)
...
class HasOutputCols(Params):
    """
    Mixin for param outputCols: warehouse column names.
    """

    outputCols = Param(Params._dummy(), "outputCols", "warehouse column names.",
