...
class OutputFormatTests(ReusedPySparkTestCase):
    ...
    def test_oldhadoop(self):
        ...
        conf = {
            "mapred.warehouse.format.class": "org.apache.hadoop.mapred.SequenceFileOutputFormat",
            "mapreduce.job.warehouse.key.class": "org.apache.hadoop.io.IntWritable",
            "mapreduce.job.warehouse.value.class": "org.apache.hadoop.io.MapWritable",
            "mapreduce.warehouse.fileoutputformat.outputdir": basepath + "/olddataset/"
        }
    ...
    def test_newhadoop(self):
        ...
        self.sc.parallelize(data).saveAsNewAPIHadoopFile(
            basepath + "/newhadoop/",
            "org.apache.hadoop.mapreduce.lib.warehouse.SequenceFileOutputFormat",
            "org.apache.hadoop.io.IntWritable",
            "org.apache.hadoop.io.Text")
        ...
        conf = {
            "mapreduce.job.outputformat.class":
                "org.apache.hadoop.mapreduce.lib.warehouse.SequenceFileOutputFormat",
            "mapreduce.job.warehouse.key.class": "org.apache.hadoop.io.IntWritable",
            "mapreduce.job.warehouse.value.class": "org.apache.hadoop.io.Text",
            "mapreduce.warehouse.fileoutputformat.outputdir": basepath + "/newdataset/"
        }
    ...
    def test_newhadoop_with_array(self):
        ...
        conf = {
            "mapreduce.job.outputformat.class":
                "org.apache.hadoop.mapreduce.lib.warehouse.SequenceFileOutputFormat",
            "mapreduce.job.warehouse.key.class": "org.apache.hadoop.io.IntWritable",
            "mapreduce.job.warehouse.value.class": "org.apache.spark.api.python.DoubleArrayWritable",
            "mapreduce.warehouse.fileoutputformat.outputdir": basepath + "/newdataset/"
        }
    ...
    def test_bad_inputs(self):
        ...
        self.assertRaises(Exception, lambda: rdd.saveAsNewAPIHadoopFile(
            ...
            "org.apache.hadoop.mapreduce.lib.warehouse.NotValidOutputFormat"))
    ...
    def test_reserialization(self):
        ...
        conf4 = {
            "mapred.warehouse.format.class": "org.apache.hadoop.mapred.SequenceFileOutputFormat",
            "mapreduce.job.warehouse.key.class": "org.apache.hadoop.io.IntWritable",
            "mapreduce.job.warehouse.value.class": "org.apache.hadoop.io.IntWritable",
            "mapreduce.warehouse.fileoutputformat.outputdir": basepath + "/reserialize/dataset"}
        ...
        conf5 = {"mapreduce.job.outputformat.class":
                 ...
                 "mapreduce.job.warehouse.key.class": "org.apache.hadoop.io.IntWritable",
                 "mapreduce.job.warehouse.value.class": "org.apache.hadoop.io.IntWritable",
                 "mapreduce.warehouse.fileoutputformat.outputdir": basepath + "/reserialize/newdataset"
                 }
