...
"""
 ...
 Usage: recoverable_network_wordcount.py <hostname> <port> <checkpoint-directory> <warehouse-file>
   <hostname> and <port> describe the TCP server that Spark Streaming would connect to receive
   data. <checkpoint-directory> directory to HDFS-compatible file system which checkpoint data
   <warehouse-file> file to which the word counts will be appended
...
if __name__ == "__main__":
    if len(sys.argv) != 5:
        print("Usage: recoverable_network_wordcount.py <hostname> <port> "
              "<checkpoint-directory> <warehouse-file>", file=sys.stderr)
        sys.exit(-1)
